...
def preload_certificates_on_startup():
    ...
    try:
        ...
        try:
            ...
            if missing_files > 0:
                logger.warning(f"⚠️ {missing_files} certificados tienen archivos faltantes")
            ...
            if not storage_file_path.exists():
                ...
                try:
                    ...
                    if media_size != storage_size:
                        should_copy = True
                        logger.info(f"📄 Archivo modificado, actualizando storage: {original_filename}")
                except Exception as e:
                    should_copy = True
            ...
            if should_copy:
                try:
                    ...
                    if hasattr(instance, 'storage_path'):
                        ...
                        logger.debug(f"📝 storage_path actualizado: {relative_path}")
